...
* Facts/Strength of Modern Symbolic Planning solvers.              :noexport:
...
+ Effects in STRIPS are *disentangled* from the current state $z_t$.
  ...
  (\rightarrow In the paper, STRIPS = *cube-like graph* from graph-theory.)
...
* Current Ongoing Work @@html:<br>@@ (msg me if you want to help me!)

Dev phase:

*_Discrete, Logical Word Embedding_ for NLP that you can plan*

　

Idea phase:

Unsupervised Motion Grounding from the Fine Time Series
...
*Unsupervised _Motion Grounding_ from the Fine Time Series*
