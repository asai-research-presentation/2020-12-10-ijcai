...
+ Requires *SotA heuristics* to tackle the problem
  + *domain-indenpendent* : our domains are *generated by NN*
...
+ Fast Downward miserably fails *during the input processing*
+ Another reason: Heavy usage of disjunctions
