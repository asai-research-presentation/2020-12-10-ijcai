...
* What characterises the */deliberative/* decision making vs */Reflex/* action?

Deliberative vs Reflex

+ Deliberative decision making: Sit-down strategist
+ Reflex agent: Pretty much every human being + animals

+ Deliberation: for a state you *understand but never encountered*
  + Fundamentally out-of-distribution
+ Reflex: a behavior learned from past experiences (incl. evolution)
...
+ Multi-step -- *deliberating about multi-step futures*
+ Systematic/complete -- *no stones unturned* + *do not turn any stone twice*

What does not need delibation?

+ Image classification (single step)
+ Machine Translation (just follow the most likely predictions / incomplete)
+ Atari Game (just follow the policy function)
+ Tasks that completeness does not matter
  + e.g. Game, where human opponent is also incomplete
